...
export const PRESETS: Array<{ name: Preset; detail: string; icon: string }> = [
  { name: 'Print Ready', detail: 'Balanced lift for clean paper output', icon: '🖨️' },
  { name: 'Document Clear', detail: 'Brightens uneven paper and shadows', icon: '📄' },
  { name: 'Natural', detail: 'Subtle correction that preserves tone', icon: '🌿' },
  { name: 'Black & White', detail: 'High contrast monochrome text', icon: '⚫' },
  { name: 'Strong Text', detail: 'Extra edge definition for small type', icon: '🔤' },
  { name: 'Photo Recovery', detail: 'Gentle lift for faded color pages', icon: '📸' },
];
