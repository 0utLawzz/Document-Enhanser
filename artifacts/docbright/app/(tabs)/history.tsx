...
const styles = StyleSheet.create({
  ...
  deleteButton: { width: 42, height: 42, borderRadius: 0, borderWidth: 3, borderColor: '#0C0C0C', alignItems: 'center', justifyContent: 'center', marginBottom: 12, backgroundColor: '#FAF6EE' },
  clearButton: { minHeight: 48, borderWidth: 3, borderColor: '#0C0C0C', borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 8, marginTop: 12, backgroundColor: '#FAF6EE' },
  clearText: { fontFamily: 'monospace', fontSize: 12, fontWeight: '700', textTransform: 'uppercase' },
});
